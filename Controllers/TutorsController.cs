...
namespace ITSL_Administration.Controllers
{
    public class TutorsController : Controller
    {
        ...
        public TutorsController(ITSLAdminDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("TutorID,Name,Surname,Email,PhoneNumber,Campus,IsRegisteredForITSL")] Tutor tutor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("TutorID,Name,Surname,Email,PhoneNumber,Campus,IsRegisteredForITSL")] Tutor tutor)
        {
            if (id != tutor.TutorID)
            {
                return NotFound();
