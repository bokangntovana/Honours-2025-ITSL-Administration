...
namespace ITSL_Administration.Controllers
{
    public class LecturersController : Controller
    {
        ...
        public LecturersController(ITSLAdminDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("LecturerID,Name,Surname,Email,PhoneNumber")] Lecturer lecturer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("LecturerID,Name,Surname,Email,PhoneNumber")] Lecturer lecturer)
        {
